...
const knowledgeBase = [
  // Flights
  {
    patterns: [/flight/i, /book.*flight/i, /airfare/i, /ticket/i, /airplane/i],
  ...
  // Visa
  {
    ...
    answer: `We offer assistance with certain visa applications. Visit ${FRONTEND_URL}/visa or contact ${process.env.SUPPORT_EMAIL || 'support@trabilis.com'} for details.`,
  },
  {
  ...
  // Policies
  {
    ...
    answer: `Our cancellation and refund policies depend on the airline or tour operator. Visit ${FRONTEND_URL}/policies or contact ${process.env.SUPPORT_EMAIL || 'support@trabilis.com'} for specifics.`,
  },
  {
  ...
  // Contact
  {
    ...
    answer: `Reach us via email at ${process.env.SUPPORT_EMAIL || 'support@trabilis.com'}, call ${process.env.SUPPORT_PHONE || '+1-800-TRABILIS'}, or message us on our social media channels.`,
  },
  {
  ...
  // Greetings
  {
    patterns: [/hello/i, /hi\b/i, /hey/i, /good.*morning/i, /good.*evening/i],
  ...
  {
    patterns: [/confirmation/i, /booking.*status/i, /reservation.*details/i],
  ...
  {
    patterns: [/.*/],
    answer: `I'm not sure about that, but you can explore our services at ${FRONTEND_URL} or contact ${process.env.SUPPORT_EMAIL || 'support@trabilis.com'} for assistance.`,
  },
]
...
function findAnswer(userMessage) {
  ...
  return (
    'I’m not sure about that, but you can check our services at ' + FRONTEND_URL
  )
}
