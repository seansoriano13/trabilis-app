...
export const viewFlightBookingHTML = async (req, res) => {
  try {
    ...
    const itineraries = (bookingDetails.amadeus_flight_offer?.itineraries || [])
      .map((itinerary, index) => {
        return `
                              ...
                              .map((segment) => {
                                ...
                                return /* HTML */ ` <div
                                  ...
                                  <div class="pdf-flight-details__leg">
                                    <p class="pdf-flight-details__stops">
                                      ${stopsLabel}
                                    </p>
    ...
    const passengerDetails = (bookingDetails.passenger_details?.travelers || [])
      .map((passenger, index) => {
