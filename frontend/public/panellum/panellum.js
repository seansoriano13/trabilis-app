...
window.pannellum = (function (E, g, p) {
    function Ba(s, k) {
        ...
        fa.innerHTML = 'Lindela Travel and Tours' //<a href="https://pannellum.org/" target="_blank">Pannellum</a> 2.5.6
        J.appendChild(fa)
        ...
        q.load.lbox.className = 'pnlm'
        q.load.lbox.innerHTML = '<div class="loader"></div>'
