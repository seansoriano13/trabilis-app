...
export const getAirlineInfo = async (id) => {
    try {
        const response = await axios.get(`${API_BASE_URL}/api/v1/metadata/airlines`, {
            params: { id }
        })
...
export const getAircraftName = async (code) => {
    try {
        const response = await axios.get(`${API_BASE_URL}/api/v1/metadata/aircraft`, {
            params: { code }
        })
...
export const getAllAircraftEntries = async () => {
    try {
        const response = await axios.get(`${API_BASE_URL}/api/v1/metadata/aircraft/all`)
        return response.data.data
    } catch (error) {
...
export const getAircraftOptions = async () => {
    try {
        const response = await axios.get(`${API_BASE_URL}/api/v1/metadata/aircraft/options`)
        return {
            success: true,
...
export const getAllAirlines = async () => {
    try {
        const response = await axios.get(`${API_BASE_URL}/api/v1/metadata/airlines/all`)
        return {
            success: true,
            data: response.data.data || []
        }
