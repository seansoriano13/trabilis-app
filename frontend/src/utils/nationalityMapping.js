...
// Create nationality options for react-select
export const getNationalityOptions = () => {
    return nationalities.map(nationality => ({
        value: nationalityToCountryCode[nationality] || nationality, // fallback to nationality name if no mapping
        label: nationality,
        nationality: nationality,
        countryCode: nationalityToCountryCode[nationality] || nationality
    }))
}
...
// Helper function to get country code from nationality name
export const getCountryCodeFromNationality = (nationality) => {
    return nationalityToCountryCode[nationality] || nationality
}
