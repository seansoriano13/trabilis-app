  ...
  const handleEditSubmit = async (e) => {
    ...
    try {
      const submitData = {
        ...
        flight_booking_reference: editForm.flight_booking_reference || null,
      }
          ...
          <div className='form-group'>
            <div className='form-group'>
              ...
              <input
                ...
                onChange={(e) =>
                  handleFormChange('flight_booking_reference', e.target.value)
                }
                className='form-input'
              />
              <small className='form-help-text'>
                Enter the flight booking reference to link flight details to
                this tour booking.
              </small>
            </div>
          </div>
