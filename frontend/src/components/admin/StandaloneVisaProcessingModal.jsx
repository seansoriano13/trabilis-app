...
const StandaloneVisaProcessingModal = ({ 
    ...
    const loadVisaProcessing = useCallback(async () => {
        ...
        try {
            ...
            if (response.data.success) {
                ...
                const mobileData = data.mobile_number || { countryCallingCode: '+63', number: '' }
                
                setFormData({
                    passenger_name: data.passenger_name || '',
                    passenger_email: data.passenger_email || '',
                    mobile_country_code: mobileData.countryCallingCode?.replace('+', '') || '63',
    ...
    const loadRequirements = async (country) => {
        ...
        try {
            const response = await adminClient.get(`/requirements?country=${encodeURIComponent(country)}`, {
                baseURL: import.meta.env.VITE_BACKEND_URL + '/api/v1/visa-processing'
            })
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            await adminClient.put(`/processings/${visaProcessing.id}/details`, {
            ...
            // Update visa status
            await adminClient.put(`/processings/${visaProcessing.id}/status`, {
            ...
            if (formData.assigned_to) {
                ...
                await adminClient.put(`/processings/${visaProcessing.id}/assignment-status`, {
                                ...
                                <div className="client-info-grid">
                                    ...
                                    <div className="form-field">
                                        ...
                                        <input
                                            ...
                                            onChange={(e) => handleFieldChange('passenger_email', e.target.value)}
                                            className="form-input"
                                        />
                                    </div>
                                    <div className="form-field">
                                        ...
                                        <Select
                                            ...
                                            onChange={(selected) => handleFieldChange('mobile_country_code', selected?.value || '63')}
                                    ...
                                    <div className="form-field">
                                        ...
                                        <Select
                                            ...
                                            value={getVisaRequiredCountryOptions().find(opt => opt.value === formData.country)}
                                    ...
                                    <div className="form-field">
                                        ...
                                        <Select
                                            ...
                                            onChange={(selected) => handleFieldChange('visa_type', selected.value)}
                                            styles={{
                                                control: (provided) => ({
                                                    ...provided,
                                                    minHeight: '40px'
                                ...
                                <div className="form-row">
                                    <div className="form-field">
                                        ...
                                        <Select
                                            ...
                                            onChange={(selected) => handleFieldChange('status', selected.value)}
                                            styles={{
                                                control: (provided) => ({
                                                    ...provided,
                                                    minHeight: '40px'
                                    ...
                                    <div className="form-field">
                                        ...
                                        <Select
                                            ...
                                            onChange={(selected) => handleFieldChange('assignment_status', selected.value)}
                                            styles={{
                                                control: (provided) => ({
                                                    ...provided,
                                                    minHeight: '40px'
                            ...
                            <div className="standalone-visa-modal__section">
                                ...
                                {loadingRequirements ? (
                                    ...
                                    <div className="empty-requirements">
                                        ...
                                        <p>Please select a destination country to view requirements</p>
                                    </div>
                                ) : requirements.length === 0 ? (
                                    <div className="empty-requirements">
                                        <FiAlertCircle className="empty-icon" />
                                        <p>No requirements found for {formData.country}</p>
                                        <p className="empty-hint">Requirements data may need to be added in the system</p>
                                    </div>
                                ) : (
                            ...
                            <div className="standalone-visa-modal__section">
                                ...
                                <div className="form-field">
                                    ...
                                    <Select
                                        ...
                                        onChange={(selected) => handleFieldChange('assigned_to', selected?.value || null)}
                                ...
                                <div className="standalone-visa-modal__section">
                                    ...
                                    <div className="payment-info-grid">
                                        ...
                                        <div className="info-item">
                                            ...
                                            <span className={`info-value status-${visaProcessing.payment_status?.toLowerCase()}`}>
