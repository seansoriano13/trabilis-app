...
const VisaProcessingModal = ({
  ...
  const createVisaProcessing = useCallback(async () => {
    try {
      const passengerName =
        `${passenger.name?.firstName || ''} ${passenger.name?.lastName || ''}`.trim()
      ...
      if (response.data.success) {
        const newProcessing = response.data.data[0]
        setVisaProcessing(newProcessing)
        const initialFormData = {
          status: newProcessing.status,
          visa_type: newProcessing.visa_type,
          requirements_status: newProcessing.requirements_status || {},
          notes: newProcessing.notes || '',
          assigned_to: newProcessing.assigned_to,
          assignment_status: newProcessing.assignment_status || 'pending',
        }
      ...
      if (response.data.success) {
        ...
        if (passengerProcessing) {
          ...
          const initialFormData = {
            ...
            assignment_status:
              passengerProcessing.assignment_status || 'pending',
          }
          setFormData(initialFormData)
          // Store the actual initial data for comparison
          initialFormDataRef.current = initialFormData
  ...
  const handleSave = async () => {
    ...
    try {
      // Update visa status
      const statusResponse = await adminClient.put(
      ...
      if (formData.assigned_to) {
        ...
        const assignmentStatusResponse = await adminClient.put(
        ...
        // Update local state with the returned data
        if (
          assignmentStatusResponse.data.success &&
          assignmentStatusResponse.data.data
        ) {
          setVisaProcessing(assignmentStatusResponse.data.data)
          setFormData((prev) => ({
            ...prev,
            assignment_status:
              assignmentStatusResponse.data.data.assignment_status,
  ...
  return (
    <div
      className='visa-processing-modal-overlay'
      onClick={handleCloseModal}
    >
      <div
        className='visa-processing-modal'
      ...
      >
        <div className='visa-processing-modal__header'>
          <div className='visa-processing-modal__title'>
            ...
            <h3>
              Visa Processing - {passenger?.name?.firstName}{' '}
          ...
          <button
            className='visa-processing-modal__close'
            onClick={handleCloseModal}
          >
            <FiX size={20} />
          </button>
                ...
                <div className='form-row'>
                  <div className='form-field'>
                    ...
                    <Select
                      ...
                      onChange={(selected) =>
                        handleStatusChange('status', selected.value)
                      }
                      styles={{
                        control: (provided) => ({
                          ...provided,
                  ...
                  <div className='form-field'>
                    ...
                    <Select
                      ...
                      onChange={(selected) =>
                        handleStatusChange('visa_type', selected.value)
                      }
                      styles={{
                        control: (provided) => ({
                          ...provided,
                ...
                <div className='form-row'>
                  ...
                  <div className='form-field'>
                    ...
                    <Select
                      ...
                      onChange={(selected) =>
                        handleStatusChange('assignment_status', selected.value)
                      }
                      styles={{
                        control: (provided) => ({
                          ...provided,
