...
const Snackbar = () => {
  ...
  const getStyles = () => {
    const baseStyles =
      'fixed top-20 right-4 z-40 max-w-sm w-full mx-4 bg-white rounded-xl shadow-2xl border border-gray-200 transform transition-all duration-500 ease-out animate-slideInRight'
