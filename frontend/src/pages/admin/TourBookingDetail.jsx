...
const TourBookingDetail = () => {
    ...
    const [updatingVisaForPassenger, setUpdatingVisaForPassenger] =
        useState(null)
    ...
    const handleVisaStatusChange = async (passengerIndex, field, value) => {
        ...
        try {
            ...
            const updatedVisaData = {
                visa_status:
                    field === 'visa_status' ? value : passenger.visa_status,
                                            ...
                                            {(() => {
                                                ...
                                                try {
                                                    if (
                                                        ...
                                                        passengers =
                                                            typeof booking.passenger_details ===
                                                            'string'
                                                                ? JSON.parse(
                                                                      booking.passenger_details
                                                                  )
                                    ...
                                    <div className='flight-card__content'>
                                        ...
                                        <div className='flight-actions'>
                                            <button
                                                ...
                                                onClick={() =>
                                                    navigate(
                                                        `/admin/flights/${flightData.id}`
                                                    )
                                                }
                                            >
                                                <FiEye /> View Full Flight
                                                Details
                                            </button>
                                            <button
                                ...
                                <div className='flight-empty'>
                                    ...
                                    <div className='flight-empty__content'>
                                        ...
                                        <p className='flight-empty__description'>
                                            This tour booking doesn't have an
                                            associated flight booking.
                                        </p>
                                        <div className='flight-empty__steps'>
                                            <div className='step'>
                                                ...
                                                <span>
                                                    Create a flight booking to
                                                    get a TRB-FLT reference
                                                </span>
                                            </div>
                                            <div className='step'>
                                                <div className='step__number'>
                    ...
                    <div className='tab-content'>
                        <div className='pdf-receipt'>
                            <div className='pdf-header'>
                                ...
                                <p>
                                    Download the official tour booking PDF
                                    receipt
                                </p>
                            </div>
