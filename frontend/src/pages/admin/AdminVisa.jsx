...
import { formatMobileNumber, getMobileTelHref } from '../../utils/mobileNumberUtils'
import {
    FiShield,
    FiUsers,
    FiDollarSign,
...
const AdminVisa = () => {
    ...
    const [processingSearchLoading, setProcessingSearchLoading] =
        useState(false)
        ...
        const fetchCounts = async () => {
            try {
                ...
                if (processingResponse.data.success) {
                    setProcessingTotal(
                        processingResponse.data.pagination?.total || 0
                    )
                }
            } catch (error) {
    ...
    const handleConfirmPayment = async () => {
        ...
        try {
            ...
            if (data.success) {
                ...
                showError(
                    data.message ||
                        'Failed to mark inquiry as ready for payment'
                )
            }
        } catch (error) {
    ...
    const getStatusBadge = (status) => {
        return (
            <span
                className={`visa__status visa__status--${status.toLowerCase()}`}
            >
                {status}
            </span>
        )
                                                ...
                                                <div className='visa__assignment'>
                                                    {inquiry.assigned_to ? (
                                                        <div className='visa__assignment-assigned'>
                                                            ...
                                                            >
                                                                {inquiry.assignment_status?.replace(
                                                                    '_',
                                                                    ' '
                                                                ) || 'pending'}
                                                            </span>
                    ...
                    <div className='visa__section'>
                        <div className='visa__section-header'>
                            ...
                            <div className='visa__section-filters'>
                                <select
                                    value={
                                        processingFilters.source_type || 'ALL'
                                    }
                                    onChange={(e) =>
                                        setProcessingFilters((prev) => ({
                                            ...prev,
                        ...
                        <div className='visa__pagination-container'>
                            <ReactPaginate
                                ...
                                nextLabel={'Next →'}
                                pageCount={Math.ceil(
                                    processingTotal / pageSize
                                )}
                                onPageChange={({ selected }) =>
                                    setProcessingPage(selected)
                                }
                                containerClassName={'visa__pagination'}
                                activeClassName={'visa__pagination--active'}
                            ...
                            {inquiryDetailsModal.inquiry && (
                                <div className='inquiry-details'>
                                    ...
                                    <div className='detail-row'>
                                        ...
                                        <span className='detail-value'>
                                            {formatMobileNumber(inquiryDetailsModal.inquiry.mobile_number)}
                                        </span>
                                    </div>
                                    <div className='detail-row'>
                                        <span className='detail-label'>
                                ...
                                <div className='payment-modal-content'>
                                    <div className='inquiry-summary'>
                                        ...
                                        <p>
                                            ...
                                            {paymentModal.inquiry.full_name}
                                        </p>
                                        <p>
                                            <strong>Email:</strong>{' '}
                                    ...
                                    <div className='payment-amount-section'>
                                        ...
                                        <p className='amount-help-text'>
                                            This amount will be shown to the
                                            client when they track their
                                            inquiry.
                                        </p>
                                    </div>
