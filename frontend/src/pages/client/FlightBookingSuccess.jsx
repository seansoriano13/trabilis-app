          ...
          <div className='w-full grid grid-cols-1 md:grid-cols-2 gap-4'>
            <div className='bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl p-4 border border-blue-200'>
              ...
              <div className='text-lg font-bold text-blue-900'>
                {bookingDetails.searchCriteria.origin}
              </div>
            </div>
            <div className='bg-gradient-to-br from-green-50 to-green-100 rounded-xl p-4 border border-green-200'>
              ...
              <div className='text-lg font-bold text-green-900'>
                {bookingDetails.searchCriteria.destination}
              </div>
            </div>
            ...
            {typeof bookingDetails.searchCriteria.travelerCount ===
              'number' && (
              <div className='bg-gradient-to-br from-indigo-50 to-indigo-100 rounded-xl p-4 border border-indigo-200 md:col-span-2'>
                ...
                <div className='text-lg font-bold text-indigo-900'>
                  {bookingDetails.searchCriteria.travelerCount}
                </div>
              </div>
            )}
          </div>
