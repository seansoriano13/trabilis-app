                        ...
                        <div className='bg-white rounded-lg p-6 shadow-sm border border-gray-200 sticky top-24'>
                            ...
                            <div className='mt-4 space-y-3 text-sm text-gray-700'>
                                <div className='flex justify-between items-center'>
                                    ...
                                    <span className='font-semibold text-right max-w-[60%] text-gray-800'>{title}</span>
                                </div>
                                <div className='flex justify-between items-center'>
                                    <span className='text-gray-600'>Dates</span>
                                    <span className='font-semibold text-gray-800'>{new Date(selectedDate.start_date).toLocaleDateString()} - {new Date(selectedDate.end_date).toLocaleDateString()}</span>
                                </div>
                                <div className='flex justify-between items-center'>
                                    <span className='text-gray-600'>Passengers</span>
                                    <span className='font-semibold text-gray-800'>{totalPassengers}</span>
                                </div>
                                {perPax > 0 && (
                                    <div className='flex justify-between items-center'>
                                        <span className='text-gray-600'>Rate per Pax</span>
                                        <span className='font-semibold text-gray-800'>PHP {perPax.toLocaleString()}</span>
                                    </div>
                                )}
                            </div>
                            <div className='mt-6 border-t border-gray-200 pt-4 space-y-3 text-sm'>
                                ...
                                <div className='flex justify-between items-center text-base font-bold pt-3 mt-3 border-t border-gray-300'>
                                    ...
                                    <span className='text-yellow-600 text-lg'>PHP {grandTotal.toLocaleString()}</span>
                                </div>
                            </div>
                ...
                <div className='bg-white rounded-lg max-w-4xl w-full max-h-[90vh] overflow-hidden'>
                    ...
                    <div className='p-6 overflow-y-auto max-h-[70vh]'>
                        <div className='prose max-w-none text-sm text-gray-700 space-y-4'>
                            <h3 className='text-lg font-semibold text-gray-900'>Travel & Tours</h3>
                            
                            <section>
                                <h4 className='font-semibold text-gray-900'>DEFINITIONS</h4>
                                <ul className='list-disc pl-6 space-y-1'>
                                    <li><strong>"We" and "us"</strong>, as your Travel Consultants and Visa consultants.</li>
                                    <li><strong>"Consultant"</strong> means an employee of Lindela Travel and tours, with the authority to book Products.</li>
                                    <li><strong>"You"</strong> means a person who makes a booking for a product with us.</li>
                                    <li><strong>"Your consultant"</strong> means the particular consultant or consultants with whom you negotiate the booking of a product.</li>
                                    <li><strong>"Supplier"</strong> means a third-party company or a person who provides products, including a wholesaler of such products.</li>
                                    <li><strong>"Product"</strong> means travel and holiday-related products and services including accommodation, leisure activities, and various forms of transport, including packaged combinations thereof.</li>
                                    <li><strong>"Travel documents"</strong> means any document (whether in electronic form or otherwise) used to confirm an arrangement with a supplier, including (without limitation) airline tickets, hotel vouchers, and tour vouchers.</li>
                            ...
                            <section>
                                ...
                                <p>Please read the following terms and conditions carefully. You must not make any booking unless you are 18 years of age or older and understand and agree with the following terms and conditions.</p>
                                <p>These terms and conditions apply to bookings you make with a consultant (in the office, over the phone, or by email) as well as online bookings made via our website. These terms and conditions govern our relationship with you. Once we accept a booking from you on behalf of a supplier, you will also have a separate contract with the supplier, which will be governed by other terms and conditions.</p>
                            </section>
                            ...
                            <section>
                                ...
                                <ul className='list-disc pl-6 space-y-1'>
                                    ...
                                    <li>Some confirmed bookings are non-refundable if canceled by you and it is your responsibility to check if this applies.</li>
                                    <li>We will be entitled to retain our service fees even if a booking is canceled or does not proceed for any reason which is not our fault.</li>
                            ...
                            <section>
                                <h4 className='font-semibold text-gray-900'>PRICES AND TAXES</h4>
                                <p>All prices that we quote are in Philippine Peso and based on twin share accommodation unless otherwise stated. Please note that prices quoted are subject to change at the discretion of the supplier prior to booking. Price changes may occur after booking because of matters outside our control which increase the cost of the product.</p>
                            </section>

                            <section>
                                <h4 className='font-semibold text-gray-900'>PRODUCTS</h4>
                                <p>All products that we quote on are subject to availability and may be withdrawn or varied by the supplier without notice. All Products and services are exclusively provided by LINDELA TRAVEL AND TOURS and in business partners.</p>
                                <p>Our Products are but not limited to Airline Tickets, Hotel Accommodations, Local & International Package tours, Land Arrangements, Passport Assistance, and Travel Insurance.</p>
                            </section>

                            <section>
                                <h4 className='font-semibold text-gray-900'>CHANGE AND CANCELLATION FEES</h4>
                                <p>Be aware that some confirmed bookings are not refundable if canceled, and also may not be transferable to another date or otherwise changed. Changes and cancellations of reservations or bookings may incur fees or penalties of 50% of the total amount of packages.</p>
                            </section>

                            <section>
                                <h4 className='font-semibold text-gray-900'>REFUNDS</h4>
                                <p>Your entitlement to a refund for canceled bookings is subject to the relevant supplier's terms and conditions. If we are managing or arranging a refund for a canceled booking on your behalf it will not be paid to you until the supplier provides the refund to us.</p>
                            </section>

                            <section>
                                <h4 className='font-semibold text-gray-900'>DEPOSITS AND PAYMENTS</h4>
                                <p>You will be required to pay a deposit (or deposits) when booking. The deposit amount varies depending on the product booked and the lead time to travel. All deposits are non-refundable for changes of mind or cancellations by you.</p>
                            </section>

                            <section>
                                <h4 className='font-semibold text-gray-900'>LIABILITY</h4>
                                <p>To the extent permitted by law, we do not accept any liability in contract, tort, or otherwise for any injury, damage, loss (including consequential loss), delay, additional expense, or inconvenience caused directly or indirectly by the acts, omissions, or default, whether negligent or otherwise, of third party providers over whom we have no direct control.</p>
                            </section>

                            <section>
                                <h4 className='font-semibold text-gray-900'>GOVERNING LAW</h4>
                                <p>If any dispute arises between you and us, the laws applicable in the Philippines will apply. You irrevocably and unconditionally submit to the exclusive jurisdiction of the courts of the Philippines.</p>
                            </section>

                            <section>
                                <h4 className='font-semibold text-gray-900'>SUMMARY OF OBLIGATIONS</h4>
                                <p>Before making a booking, it is important that you meet the following requirements:</p>
                                <ul className='list-disc pl-6 space-y-1'>
                                    <li>You are over the age of eighteen (18) and have sufficient funds to pay for the travel services.</li>
                                    <li>You have read our terms and conditions and if booking for third parties warrants that you have their authority to do so.</li>
                                    ...
                                    <li>You are responsible for confirming departure times of any booking services at least 24 hours prior to travel.</li>
