...
function VisaProcessingSuccess() {
  ...
  const getContent = () => {
    ...
    return {
      ...
      message:
        'Your payment is being processed. You will receive an email confirmation soon.',
      buttonText: 'Return to Home',
      buttonAction: () => navigate('/'),
    }
  }
                ...
                {processingDetails?.submittedAt && (
                  <div className='flex items-center justify-between'>
                    ...
                    <span className='text-gray-600'>
                      {new Date(processingDetails.submittedAt).toLocaleString()}
                    </span>
                  </div>
                )}
              </div>
                ...
                {processingDetails.destination && (
                  <div className='bg-gradient-to-br from-teal-50 to-cyan-100 rounded-2xl p-6 border border-teal-200 shadow-lg'>
                    <div className='flex items-center gap-3 mb-3'>
                      ...
                      <div className='font-semibold text-teal-800 text-lg'>
                        Destination
                      </div>
                    </div>
