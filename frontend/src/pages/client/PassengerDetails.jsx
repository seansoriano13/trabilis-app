  ...
  useEffect(() => {
    if (validationErrors.length > 0) {
      ...
      const detailsElement = document.querySelector(
        `.passenger-form__item:nth-child(${firstErrorIndex + 1}) details`
      )
      if (detailsElement) {
          ...
          <details className='passenger-form__details'>
            <summary className='passenger-form__summary'>
              ...
              <p className='passenger-form__notice'>
                Please fill personal information as shown in the passport
              </p>
            </summary>
            <div className='passenger-form__fields'>
              <h2 className='passenger-form__header'>Personal Information</h2>

              {/* Title field - only for adults */}
              {passenger.type === 'ADULT' && (
                <div className='passenger-form__field'>
                  <label className='passenger-form__label'>Title</label>
                  <Select
                  ...
                  />
                  {validationErrors
                    .filter((e) => e.index === index && e.field === 'title')
                    .map((e) => (
                      <p
                        key={`${e.index}-${e.field}-${e.message}-${Date.now()}`}
              ...
              <div className='passenger-form__field'>
                <label className='passenger-form__label'>First Name</label>
                <input
                  type='text'
                  className='passenger-form__input'
                  value={passenger.name.firstName}
                  onChange={(e) =>
                    handleChange(index, 'name.firstName', e.target.value)
                  }
                  required
                />
                {validationErrors
                  .filter(
                    (e) => e.index === index && e.field === 'name.firstName'
                  )
                  .map((e) => (
                    <p
                      key={`${e.index}-${e.field}-${e.message}-${Date.now()}`}
              ...
              <div className='passenger-form__field'>
                <label className='passenger-form__label'>Last Name</label>
                <input
                  type='text'
                  className='passenger-form__input'
                  value={passenger.name.lastName}
                  onChange={(e) =>
                    handleChange(index, 'name.lastName', e.target.value)
                  }
                  required
                />
                {validationErrors
                  .filter(
                    (e) => e.index === index && e.field === 'name.lastName'
                  )
                  .map((e) => (
                    <p
                      key={`${e.index}-${e.field}-${e.message}-${Date.now()}`}
              ...
              <div className='passenger-form__field'>
                <label className='passenger-form__label'>Birth Date</label>
                <Flatpickr
                  className='passenger-form__input'
                  value={
                  ...
                  onChange={([date]) =>
                    handleChange(index, 'dateOfBirth', formatToYMD(date))
                  }
                  options={{
                    maxDate: 'today',
                    dateFormat: 'Y-m-d',
                ...
                />
                {validationErrors
                  .filter((e) => e.index === index && e.field === 'dateOfBirth')
                  .map((e) => (
                    <p
                      key={`${e.index}-${e.field}-${e.message}-${Date.now()}`}
                      className='error-message'
              ...
              <div className='passenger-form__field'>
                <label className='passenger-form__label'>Gender</label>
                <div className='passenger-form__gender-options'>
                  ...
                  <p
                    ...
                    className={`passenger-form__gender-option ${
                      passenger.gender === 'FEMALE' ? 'active' : ''
                    }`}
                  >
                    Female
                  </p>
                ...
                {validationErrors
                  .filter((e) => e.index === index && e.field === 'gender')
                  .map((e) => (
                    <p
                      key={`${e.index}-${e.field}-${e.message}-${Date.now()}`}
                      className='error-message'
              ...
              {passenger.type === 'ADULT' && (
                <>
                  ...
                  <div className='passenger-form__field'>
                      ...
                      styles={{
                        ...
                        control: (provided, state) => ({
                          ...(formSelectStyles.control
                            ? formSelectStyles.control(provided, state)
                            : provided),
                          padding: '.5rem 1rem',
                        }),
                      }}
                    ...
                    {validationErrors
                      .filter(
                        (e) =>
                          e.index === index &&
                          e.field === 'contact.phones[0].countryCallingCode'
                      )
                      .map((e) => (
                        <p
                          key={`${e.index}-${e.field}-${
                  ...
                  <div className='passenger-form__field'>
                    <label className='passenger-form__label'>Phone</label>
                    <input
                      type='tel'
                      className='passenger-form__input'
              ...
              <h2 className='passenger-form__header'>Passport Information</h2>
              <div className='passenger-form__field'>
                <label className='passenger-form__label'>Passport Number</label>
                <input
                  type='text'
                  className='passenger-form__input'
                  value={passenger.documents[0]?.number || ''}
                  onChange={(e) =>
                    handleChange(index, 'documents[0].number', e.target.value)
                  }
                />
                {validationErrors
                  .filter(
                    (e) =>
                      e.index === index && e.field === 'documents[0].number'
                  )
                  .map((e) => (
                    <p
                      key={`${e.index}-${e.field}-${e.message}-${Date.now()}`}
              ...
              <div className='passenger-form__field'>
                <label className='passenger-form__label'>Nationality</label>
                <Select
                  className='passenger-form__select'
                  ...
                  value={
                    nationalityOptions.find(
                      (opt) =>
                        opt.value ===
                        (passenger.documents[0]?.nationality || 'PH')
                    ) || null
                  }
                  onChange={(selected) =>
                    handleChange(
                ...
                {validationErrors
                  .filter(
                    (e) =>
                      e.index === index &&
                      e.field === 'documents[0].nationality'
                  )
                  .map((e) => (
                    <p
                      key={`${e.index}-${e.field}-${e.message}-${Date.now()}`}
              ...
              <div className='passenger-form__field'>
                ...
                <Select
                  ...
                  value={
                    issuanceCountryOptions.find(
                      (opt) =>
                        opt.value === passenger.documents[0]?.issuanceCountry
                    ) || null
                  }
                  onChange={(selected) =>
                    handleChange(
                ...
                {validationErrors
                  .filter(
                    (e) =>
                      e.index === index &&
                      e.field === 'documents[0].issuanceCountry'
                  )
                  .map((e) => (
                    <p
                      key={`${e.index}-${e.field}-${e.message}-${Date.now()}`}
              ...
              <div className='passenger-form__field'>
                ...
                <Flatpickr
                  ...
                  value={
                    passenger.documents[0]?.issuanceDate
                      ? new Date(passenger.documents[0].issuanceDate)
                      : null
                  }
                  onChange={([date]) =>
                    handleChange(
                ...
                {validationErrors
                  .filter(
                    (e) =>
                      e.index === index &&
                      e.field === 'documents[0].issuanceDate'
                  )
                  .map((e) => (
                    <p
                      key={`${e.index}-${e.field}-${e.message}-${Date.now()}`}
              ...
              <div className='passenger-form__field'>
                ...
                <Flatpickr
                  ...
                  value={
                    passenger.documents[0]?.expiryDate
                      ? new Date(passenger.documents[0].expiryDate)
                      : null
                  }
                  onChange={([date]) =>
                    handleChange(
                ...
                {validationErrors
                  .filter(
                    (e) =>
                      e.index === index && e.field === 'documents[0].expiryDate'
                  )
                  .map((e) => (
                    <p
                      key={`${e.index}-${e.field}-${e.message}-${Date.now()}`}
              ...
              <div className='passenger-form__field'>
                ...
                <Select
                  ...
                  value={
                    issuanceCountryOptions.find(
                      (opt) =>
                        opt.value ===
                        (passenger.documents[0]?.validityCountry || 'PH')
                    ) || null
                  }
                  onChange={(selected) =>
                    handleChange(
                ...
                {validationErrors
                  .filter(
                    (e) =>
                      e.index === index &&
                      e.field === 'documents[0].validityCountry'
                  )
                  .map((e) => (
                    <p
                      key={`${e.index}-${e.field}-${e.message}-${Date.now()}`}
              ...
              <div className='passenger-form__field'>
                <label className='passenger-form__label'>Birth Place</label>
                <input
                  type='text'
                  className='passenger-form__input'
                ...
                {validationErrors
                  .filter(
                    (e) =>
                      e.index === index && e.field === 'documents[0].birthPlace'
                  )
                  .map((e) => (
                    <p
                      key={`${e.index}-${e.field}-${e.message}-${Date.now()}`}
              ...
              {passenger.type === 'CHILD' && (
                <div className='passenger-form__field'>
                  <label className='passenger-form__label'>Linked Adult</label>
                  <Select
                    className='passenger-form__select'
                    options={passengers
                      ...
                      .map((adult, idx) => ({
                        ...
                        label:
                          `${adult.name?.firstName || ''} ${adult.name?.lastName || ''}`.trim() ||
                          `Adult ${idx + 1}`,
                      }))}
                    value={
                      passengers
                        ...
                        ? {
                            ...
                            label:
                              `${passengers.find((p) => p.id === passenger.linkedAdultId)?.name?.firstName || ''} ${passengers.find((p) => p.id === passenger.linkedAdultId)?.name?.lastName || ''}`.trim(),
                          }
                        : null
                    }
                    onChange={(selected) =>
                  ...
                  {validationErrors
                    .filter(
                      (e) => e.index === index && e.field === 'linkedAdultId'
                    )
                    .map((e) => (
                      <p
                        key={`${e.index}-${e.field}-${e.message}-${Date.now()}`}
              ...
              {tourPackage?.visa_required && (
                <>
                  <h2 className='passenger-form__header'>Visa Status</h2>
                  <div className='passenger-form__field'>
                    <label className='passenger-form__label'>
                    ...
                    <Select
                      ...
                      options={[
                        ...
                        {
                          value: 'already_has',
                          label: 'I already have a visa',
                        },
                        {
                          value: 'needs_processing',
                          label: 'I need visa processing',
                        },
                      ]}
                      value={{
                    ...
                    {validationErrors
                      .filter(
                        (e) => e.index === index && e.field === 'visa_status'
                      )
                      .map((e) => (
                        <p
                          key={`${e.index}-${e.field}-${
                  ...
                  {passenger.visa_status === 'already_has' && (
                    <>
                      <div className='passenger-form__field'>
                        ...
                        {validationErrors
                          .filter(
                            (e) => e.index === index && e.field === 'visa_type'
                          )
                          .map((e) => (
                            <p
                              key={`${e.index}-${e.field}-${
                      ...
                      <div className='passenger-form__field'>
                        ...
                        <Select
                          ...
                          options={[
                            ...
                            {
                              value: 'expiring_soon',
                              label: 'Expiring Soon (within 6 months)',
                            },
                            {
                              value: 'expired',
                              label: 'Expired',
                          ...
                          value={{
                            ...
                            label:
                              passenger.existing_visa_status === 'valid'
                                ? 'Valid'
                                : passenger.existing_visa_status ===
                                    'expiring_soon'
                                  ? 'Expiring Soon (within 6 months)'
                                  : passenger.existing_visa_status === 'expired'
                                    ? 'Expired'
                                    : 'Not Specified',
                          }}
                          onChange={(selected) =>
                      ...
                      {(passenger.existing_visa_status === 'valid' ||
                        passenger.existing_visa_status === 'expiring_soon') && (
                        <div className='passenger-form__field'>
                          <label className='passenger-form__label'>
                            Visa Expiry Date
                          </label>
                    ...
                    <div className='visa-processing-notice'>
                      <div className='visa-processing-notice__content'>
                        ...
                        <p className='visa-processing-notice__text'>
                          ...
                          Required documents will be collected after booking
                          confirmation.
                        </p>
                      </div>
                    </div>
                      ...
                      <div className='visa-assistance-notice'>
                        <div className='visa-assistance-notice__content'>
                          ...
                          <p className='visa-assistance-notice__text'>
                            Your visa has expired. We recommend visa processing
                            assistance to ensure smooth travel. Would you like
                            to include visa processing in your booking?
                          </p>
...
function PassengerDetails() {
  ...
  // Check if user returned from payment cancellation
  useEffect(() => {
    ...
    if (returnedFromPayment === 'true') {
      ...
      try {
        ...
        if (savedState) {
          ...
          if (isRecent && savedPassengers && searchCriteria) {
            setPassengers(savedPassengers)
            setShowReturnedFromPayment(true)
            console.log('✅ Form state restored from payment cancellation')

            // Show a notification that form was restored
            setTimeout(() => {
              showError(
                'Your form data has been restored. You can continue editing and try payment again.',
                'info'
              )
            }, 500)
          }
  ...
  // Get traveler count from state or fallback to restored data
  const getTravelerCount = () => {
    if (state?.travelerCount) {
      return state.travelerCount
    }

    // Try to get from saved form state if state is null
    try {
      const savedState = sessionStorage.getItem('passengerFormState')
      if (savedState) {
        const formState = JSON.parse(savedState)
        const { searchCriteria } = formState
        if (searchCriteria?.travelerCount) {
          return searchCriteria.travelerCount
        }
      }
    } catch (error) {
      console.warn('Failed to get traveler count from saved state:', error)
    }
  ...
  const { adults, children } = travelerCount
  const totalPassengers = adults + children

  // Get flight offer from state or fallback to restored data
  const getFlightOffer = () => {
    ...
    try {
      ...
      if (savedState) {
        const formState = JSON.parse(savedState)
        const { flightOffer } = formState
        if (flightOffer) {
          return flightOffer
        }
      }
    } catch (error) {
      console.warn('Failed to get flight offer from saved state:', error)
    }
  ...
  const flightOffer = getFlightOffer()
  ...
  // State to temporarily disable unsaved changes tracking during form submission
  ...
  const { resetUnsavedChanges } = useUnsavedChanges(
    ...
    { passengers },
    {
      enabled: !isSubmitting, // Disable tracking when submitting
  ...
  // Get search criteria from state or fallback to restored data
  const getSearchCriteria = () => {
    if (state?.origin && state?.destination) {
      return {
        origin: state.origin,
        destination: state.destination,
        inboundDeparture: state.inboundDeparture,
        outboundDeparture: state.outboundDeparture,
      }
    }
    ...
    try {
      ...
      console.warn('Failed to get search criteria from saved state:', error)
    }
  ...
  const { origin, destination, inboundDeparture, outboundDeparture } =
    searchCriteria
  ...
  const [showReturnedFromPayment, setShowReturnedFromPayment] = useState(false)
  ...
  const handleSubmit = async () => {
    const errors = []
    setIsLoading(true)
    setIsSubmitting(true) // Disable unsaved changes tracking during submission
    ...
    try {
      for (const [index, passenger] of passengers.entries()) {
        try {
          ...
          if (passenger.type === 'CHILD') {
            const linkedAdult = passengers.find(
              (adult) => adult.id === passenger.linkedAdultId
            )
          ...
          if (passenger.type === 'CHILD') {
            if (!passenger.linkedAdultId) {
              ...
              const linkedAdult = passengers.find(
                (p) => p.id === passenger.linkedAdultId
              )
      ...
      if (errors.length > 0) {
        ...
        setIsLoading(false)
        setIsSubmitting(false) // Re-enable unsaved changes tracking
        return
      }
      ...
      const normalizedTravelers = passengers.map((p, idx) => {
        ...
        if (p.type === 'CHILD') {
          ...
          const linkedAdult = passengers.find(
            (adult) => adult.id === p.linkedAdultId
          )
          if (linkedAdult && linkedAdult.contact) {
      ...
      normalizedTravelers.forEach((traveler, index) => {
        if (
          ...
          validationErrors.push(
            `Traveler ${index + 1} (${traveler.type}) is missing contact information`
          )
        }
        if (traveler.type === 'CHILD' && !traveler.linkedAdultId) {
          validationErrors.push(
            `Child traveler ${index + 1} is missing linkedAdultId`
          )
        }
      })
      ...
      // Store form state in sessionStorage before payment (in case user cancels)
      try {
        const formState = {
          passengers,
          searchCriteria,
          flightOffer,
          flightId: window.location.pathname.split('/').pop(), // Extract flight ID from URL
          timestamp: Date.now(),
        }
        sessionStorage.setItem('passengerFormState', JSON.stringify(formState))
        console.log('✅ Form state saved to sessionStorage before payment')
      } catch (error) {
        console.warn('Failed to save form state:', error)
      }

      // Reset unsaved changes before redirecting to payment
      resetUnsavedChanges()
      setIsLoading(false)
      ...
      if (
        ...
        if (
          amadeusError.code === 34651 &&
          amadeusError.title === 'SEGMENT SELL FAILURE'
        ) {
          errorMessage = 'Flight No Longer Available'
          errorDetails =
            'This flight segment is no longer available for booking. This commonly happens in our test environment. Please try selecting a different flight or search for new flights.'
        } else if (amadeusError.code === 34652) {
          errorMessage = 'Flight Offer Expired'
          errorDetails =
            'This flight offer has expired. Please search for new flights and try again.'
        } else if (amadeusError.code === 34653) {
          errorMessage = 'Insufficient Seats'
          errorDetails =
            'Not enough seats available for your booking. Please try with fewer passengers or select a different flight.'
    ...
    <div className='passenger-details passenger-details--client-flight pt-[var(--default-padding-top)] lg:pt-25 md:pt-35'>
      <div className='passenger-details__travel-info max-w-[1200px] mx-auto w-screen'>
        <div className='passenger-details__route'>
          ...
          <h3 className='passenger-details__destination'>{destination}</h3>
        </div>
        <div className='passenger-details__meta'>
          <p className='passenger-details__dates'>{inboundDeparture}</p>
          <p className='passenger-details__dates'>{outboundDeparture}</p>
        </div>
      ...
      <div className='passenger-details__form-wrapper'>
                  ...
                  <button
                    ...
                    onClick={() =>
                      setValidationErrors((prev) =>
                        prev.filter((error) => error.field !== 'booking')
                      )
                    }
        ...
        {/* Returned from Payment Banner */}
        {showReturnedFromPayment && (
            ...
            <div className='flex items-center gap-3'>
              ...
              <div>
                ...
                <p className='text-sm text-blue-700'>
                  Your form data has been restored. You can continue editing and
                  try payment again.
                </p>
              </div>
              <button
                onClick={() => setShowReturnedFromPayment(false)}
                className='ml-auto text-blue-600 hover:text-blue-800 text-xl font-bold'
              >
                ×
              </button>
            </div>
        ...
        <div className='mb-4 p-3 bg-yellow-50 border border-yellow-200 rounded-lg'>
          <p className='text-sm text-yellow-800'>
            <strong>Testing Mode:</strong> Form is pre-filled with valid test
            data. You can modify any field or use the buttons above to
            clear/fill data.
          </p>
        </div>
        <PassengerForm
            ...
            <div className='prose max-w-none text-sm text-gray-700 space-y-4'>
              ...
              <section>
                ...
                <ul className='list-disc pl-6 space-y-1'>
                  <li>
                    All Guests, including children and infants, must present
                    valid identification at check-in.
                  </li>
                  <li>
                    Check-in begins 3 hours prior to the flight for seat
                    assignment and closes 75 minutes prior to the scheduled
                    departure.
                  </li>
                  <li>
                  ...
                  <li>
                    Transportation and other services provided by the carrier
                    are subjected to conditions of contract and other important
                    notices. Please ensure that you have received these notices,
                    and if not, contact the booking partner or issuing carrier
                    to obtain a copy prior to the commencement of your trip.
                  </li>
                  <li>
                    If the passenger journey involves an ultimate destination or
                    stop in a country other than the country of departure, the
                    Warsaw Convention may be applicable and this convention
                    governs and on most case limits the liability of carriers
                    for death or personal injury and in respect of loss of or
                    damage to baggage.
                  </li>
                  <li>
                    Please check the figures / timings as they may change time
                    to time without any notice to the passenger.
                  </li>
              ...
              <section>
                ...
                <ul className='list-disc pl-6 space-y-1'>
                  <li>
                    ...
                    completed within 6 days of booking, your reservation will be
                    automatically cancelled.
                  </li>
                  <li>
                    <strong>Cancellation Time:</strong> The cancellation will
                    occur at 00:00 (midnight) local time on the 6th day if no
                    time is specified.
                  </li>
                  <li>
                    <strong>Ticket Issuance:</strong> Tickets will be issued
                    immediately upon successful payment confirmation.
                  </li>
                  <li>
                    <strong>Important:</strong> Please ensure payment is
                    completed promptly to secure your booking and prevent
